...
public class PlayerController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        gunClone.GetComponent<Gun>().animator = aminate;
        ...
        gunClone2.GetComponent<Gun>().animator = aminate;
        ...
        currentGun = gunClone;
        currentGun.GetComponent<Gun>().animator = aminate;
    ...
    public void OnSprint(InputAction.CallbackContext context)
    {
        ...
        if (context.performed)
        {
            ...
            if (reload)
                return;
            aminate.SetBool("Sprinting", true);
            is_sprinting = true;
            updateSprint();
        }
        if (context.canceled)
        {
            cancelSprint();
            aminate.SetBool("Sprinting", false);
        }
    ...
    public void OnAim(InputAction.CallbackContext context)
    {
        ...
        if (context.performed)
        {
            ...
            playerSpeed -= 5;
            aminate.SetBool("Aiming", true);
        }
        if (context.canceled)
        {
            targetFieldOfView = 60;
            playerSpeed += 5;
            aminate.SetBool("Aiming", false);
            is_aiming = false;
        }
    }
